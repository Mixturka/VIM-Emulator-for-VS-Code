...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('extension.vimEmulator', () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.vimEmulator.openCommandPalette', () => {
        vscode.commands.executeCommand('workbench.action.showCommands');
    }));
    // Bind the 'escape' key to the onEscapePressed command
    context.subscriptions.push(vscode.commands.registerTextEditorCommand('extension.vimEmulator.onEscapePressed', () => {
        openCommandPaletteAndExecuteVimEmulatorCommand();
    }));
    context.subscriptions.push(vscode.commands.registerCommand('extension.vimEmulator.substitute', () => {
...
function handleSubstituteCommand(substituteCommand) {
